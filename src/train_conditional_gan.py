...
def train_step(generator, discriminator, g_opt, d_opt,
    ...
    with tf.GradientTape() as disc_tape:
        # Generate fake images with real scores
        fake_images = generator([noise, real_scores], training=True)

        # Discriminator predictions
        real_output = discriminator([real_images, real_scores], training=True)
        fake_output = discriminator([fake_images, real_scores], training=True)
